...
**Stack:** Plain HTML/CSS/JS. No framework, no bundler, no `package.json`.
...
4. **Test visually.** For any visual change, open the file locally
   (`python3 -m http.server`) and check it in a real browser before calling
   it done.
