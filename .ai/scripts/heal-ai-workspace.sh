...
# leave the workspace stale (repairs any vendor symlink — CLAUDE.md,
# .claude/settings.json, etc. — that got clobbered by a tool that doesn't
# preserve symlinks, and re-marks hooks executable).
